...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        public void Can_Paginate()
        {
            ...
            // Act
            ProductsListViewModel result = controller.List(null, 2).ViewData.Model as
        ...
        public void Can_Filter_Products()
        {
            ...
            Assert.True("P2" == result[0].Name && "Cat2" == result[0].Category);
            Assert.True("P4" == result[1].Name && "Cat2" == result[1].Category);
        }

        [Fact]
        public void Genereate_Category_Specific_Product_Count()
        {
            Mock<IProductRepository> mock = new Mock<IProductRepository>();
            mock.Setup(m => m.Products).Returns(new Product[] {
                new Product { ProductID = 1, Name = "P1", Category = "Cat1" },
            ...
            int? res3 = GetModel(controller.List(null))?.PagingInfo.TotalItems;
            int? res4 = GetModel(controller.List("Cat5"))?.PagingInfo.TotalItems;
